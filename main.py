...
class TemplateForecaster(ForecastBot):
    ...
    async def _run_forecast_on_binary(
        ...
        prompt = clean_indents(
            ...
            Now you take your probability and you extremize it. 
            The extremizing formula is (Probability^1.5)/(probability^1.5 + (1-probability)^1.5) 
            Do not revise the extremized probability downward or upward afterward. 
            The final answer should reflect the extremized result.
